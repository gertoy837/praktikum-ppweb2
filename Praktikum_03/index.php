    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="kunjungan.php">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="email" name="email" type="email" class="form-control" aria-describedby="emailHelpBlock"
                        required="required">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    ...
                    <span id="messageHelpBlock" class="form-text text-muted">tulis keperluan kamu mengunjungi
                        perpustakaan.</span>
                </div>
            </div>
            <div class="form-group row">
