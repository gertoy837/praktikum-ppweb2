...
<body>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input name="produk" id="produk1" type="radio" class="custom-control-input" value="Televisi"
                                required>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input name="produk" id="produk3" type="radio" class="custom-control-input"
                                value="Mesin Cuci" required>
    ...
    $nama_customer = isset($_GET['nama']) ? htmlspecialchars($_GET['nama']) : "";
    ...
    if ($produk == 'Televisi') {
        $total_belanja = $produk1 * $jumlah;
    } elseif ($produk == 'Kulkas') {
        $total_belanja = $produk2 * $jumlah;
    } elseif ($produk == 'Mesin Cuci') {
        $total_belanja = $produk3 * $jumlah;
    }

    // MENCETAK HASIL
    if ($nama_customer && $produk && $jumlah) {
        echo '<div class="container col-12 col-md-4">
                <div class="card">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item bg-light">Nama Customer : ' . $nama_customer . '</li>
                        <li class="list-group-item bg-light">Produk : ' . $produk . '</li>
                        <li class="list-group-item bg-light">Jumlah : ' . $jumlah . '</li>
                        <li class="list-group-item bg-light">Total Belanja : Rp. ' . number_format($total_belanja, 0, '', '.') . '</li>
                    </ul>
                </div>
            </div>';
    }
