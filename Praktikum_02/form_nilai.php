...
<body>
    ...
    <main role="main" class="container mt-3">
        ...
        <form class="mx-auto" action="nilai_siswa.php" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-7">
                    <select id="matkul" class="custom-select" name="matkul" required="required">
            ...
            <div class="form-group row">
                ...
                <div class="col-7">
                    <input id="nilai_uts" placeholder="Nilai UTS" name="nilai_uts" type="number" class="form-control" required="required"
                        min="0" max="100">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-7">
                    <input id="nilai_uas" placeholder="Nilai UAS" name="nilai_uas" type="number" class="form-control" required="required"
                        min="0" max="100">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-7">
                    <input id="nilai_tugas" placeholder="Nilai Tugas" name="nilai_tugas" type="number" class="form-control"
    ...
    <footer class="mt-5" style="bottom: 0; left: 0; right: 0; position: fixed;">
        <nav class="navbar navbar-expand-md navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="#">Develop By Coffe <i class="fa fa-coffee" aria-hidden="true"></i> &copy;
                    <!-- <?= date("Y") ?> -->
                    2025
                </a>
            </div>
